...
function Atomnum(atomnumbers,mol) {
...
function Ahrahams(smartsA, functionA, smartsB, functionB, smartsODT,functionODT,mol){
...
// generate list of atom numbers
var listofatomnumbers = mol.getAtomicNums();
var atomnumbers = [];
for (m=0;m<listofatomnumbers.size();m++){
    atomnumbers.push(listofatomnumbers.get(m));
}

//console.log("Atomnumbers:",atomnumbers);
// calculate the result

var res = Atomnum(atomnumbers,mol);
console.log(res);