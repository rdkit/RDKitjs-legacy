...
var mysmiles = process.argv[2]; //value will be "node"
var thresholdvalue = parseFloat(process.argv[3]); //value will be "node"
...
MongoClient.connect(mongourl, 
  function(err, db) {
    ...
    */
    ...
    FPfrequency(mysmiles, thresholdvalue, function(err,res){
      if(err){console.error(err);}
      console.log(res.results);
      console.log("time:" + res.timeDiff);
      endProcess();
    });  
  }
);
